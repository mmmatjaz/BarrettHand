...
\begin{figure}[!h]
    ...
    \end{center}
\end{figure}
The BHSupervisory server application can control either BH280, BH262 or both simultaneously. A few parameters must be set to start the server application. These are given as arguments in the order as listed in table \ref{table1}. If application is launched without any arguments, default settings are used. The following line starts the server on port 5555, and only the bh280 will be controlled.
\begin{center}
